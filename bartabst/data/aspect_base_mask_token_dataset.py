...
from fairseq.data import Dictionary, BaseWrapperDataset, LRUCacheDataset


class AspectBaseMaskTokensDataset(BaseWrapperDataset):
    """
    ...
    def __getitem_cached__(self, seed: int, epoch: int, index: int):
        with data_utils.numpy_seed(self.seed, self.epoch, index):
            ...
            assert (
                self.mask_idx['mask'] not in item
